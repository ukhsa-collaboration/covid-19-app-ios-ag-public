...
class SelfReportingSymptomseScreenTest: XCTestCase {

    @Propped
    private var runner: ApplicationRunner<SelfReportingSymptomsScreenScenario>

    func testBasics() throws {
        try runner.run { app in
            let screen = SelfReportingSymptomsScreen(app: app)
