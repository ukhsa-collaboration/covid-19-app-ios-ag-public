...
class SelfReportingSymptomsDateScreenTest: XCTestCase {

    @Propped
    private var runner: ApplicationRunner<SelfReportingSymptomsDateScreenScenario>

    func testBasics() throws {
        try runner.run { app in
            let screen = SelfReportingSymptomsDateScreen(app: app)
