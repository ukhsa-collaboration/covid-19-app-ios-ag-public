...
public protocol SettingsViewControllerInteracting {
    ...
    var shouldShowVenueHistory: Bool { get }
}
...
public class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private var content: [Section] {
        ...
        let section = Section(rows: interacting.shouldShowVenueHistory
                              ? [languageRow, myAreaRow, manageMyDataRow, venuHistoryRow, animations]
                              : [languageRow, myAreaRow, manageMyDataRow, animations])
        return [section]
    }
