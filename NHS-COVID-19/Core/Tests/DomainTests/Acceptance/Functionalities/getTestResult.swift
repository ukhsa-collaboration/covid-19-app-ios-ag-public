...
func getTestResult(result: VirologyTestResult.TestResult, testKitType: VirologyTestResult.TestKitType, endDate: Date, diagnosisKeySubmissionSupported: Bool) -> String {
