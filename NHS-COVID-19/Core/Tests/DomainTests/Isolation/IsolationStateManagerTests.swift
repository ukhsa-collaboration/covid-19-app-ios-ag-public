...
class IsolationStateManagerTests: XCTestCase {
    ...
    private struct TestState {
        ...
        var callbackCount = 0
        var isolationState = IsolationLogicalState.isolating(Isolation(fromDay: .today, untilStartOfDay: .today, reason: Isolation.Reason(indexCaseInfo: IsolationIndexCaseInfo(hasPositiveTestResult: false, testKitType: nil, isSelfDiagnosed: true, isPendingConfirmation: false), isContactCase: false)), endAcknowledged: false, startAcknowledged: false)
    }
