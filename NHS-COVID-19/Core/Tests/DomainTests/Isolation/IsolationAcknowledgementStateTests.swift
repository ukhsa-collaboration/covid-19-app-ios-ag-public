...
class IsolationAcknowledgementStateTests: XCTestCase {
    ...
    func testAcknowledgementNotNeededWhenIsolatingAndNotAboutToEnd() throws {
        ...
        let state = IsolationAcknowledgementState(
            logicalState: .isolating(Isolation(fromDay: .today, untilStartOfDay: endDay, reason: .indexCase(hasPositiveTestResult: false)), endAcknowledged: false, startAcknowledged: true),
    ...
    func testAcknowledgementNeededWhenIsolatingAndEndLessThanThresholdAway() throws {
        ...
        let isolation = Isolation(fromDay: .today, untilStartOfDay: endDay, reason: .indexCase(hasPositiveTestResult: false))
        var callbackCount = 0
        let state = IsolationAcknowledgementState(
            logicalState: .isolating(isolation, endAcknowledged: false, startAcknowledged: true),
            now: now,
    ...
    func testAcknowledgementNotNeededWhenIsolatingEndLessThanThresholdAwayButAlreadyAcknowledged() throws {
        ...
        let state = IsolationAcknowledgementState(
            logicalState: .isolating(Isolation(fromDay: .today, untilStartOfDay: endDay, reason: .indexCase(hasPositiveTestResult: false)), endAcknowledged: true, startAcknowledged: true),
            now: now,
            acknowledgeStart: {},
            acknowledgeEnd: {}
        )
